export default {
  ...
  minimumWithdrawable: (amount) => `Minimum Withdrawable ${amount} AED`,
  maximumWithdrawable: (amount) => `Maximum Withdrawable ${amount} AED`,
  ...
  logout: 'Logout',
  logWithBiometrics: (biometricsType) => `Log In Instantly with ${biometricsType}`,
  allowBiometrics: (biometricsType) => `Allow ${biometricsType} access`,
  ...
  useBiometricsToLogIn: (biometricsType) => `Use ${biometricsType} to log in`,
  tryAgain: 'Try again',
